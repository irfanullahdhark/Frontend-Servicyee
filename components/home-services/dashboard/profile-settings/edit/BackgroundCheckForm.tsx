...
const BackgroundCheckForm = () => {
  ...
  const handleSubmit = () => {
    if (confirmPolicy) {
      alert(`${dob} ${lastName}the request has been submited`);
    } else {
      setPolicyError("Please confirm the privacy and policy to continue");
    }
  };
  return (
    <div className="max-w-2xl w-full mx-auto">
      <div className="space-y-6">
        <div className="">
          <h1 className="font-bold text-xl">Submit a free background check</h1>
          <p className="text-sm text-gray-500 mt-2">
            Your information is kept confidential and private. Make sure
          ...
          <section>
            ...
            <div className="space-y-4">
             ...
             bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100"
                ...
                <h1 className="font-bold mb-4">Social security number</h1>
                <Input
                  type="text"
        ...
        <div
          ...
          } justify-between items-center border  p-4`}
        >
          <div className="flex flex-row gap-2 items-center">
            <Checkbox
              id="confirmPolicy"
              className="my-4 mr-2 data-[state=checked]:border-sky-600 data-[state=checked]:bg-sky-600 data-[state=checked]:text-white dark:data-[state=checked]:border-sky-700 dark:data-[state=checked]:bg-sky-700"
              onCheckedChange={handlePolicyConfirm}
            />
            <label htmlFor="confirmPolicy" className="text-xs">
              By checking this box, I authorize a background check and agree to{" "}
        ...
        <p className="text-red-500 dark:text-red-400">{policyError}</p>
      </div>
    </div>
  );
};
